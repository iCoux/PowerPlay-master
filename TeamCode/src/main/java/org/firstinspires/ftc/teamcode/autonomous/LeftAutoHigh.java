...
public class LeftAutoHigh extends LinearOpMode {
    ...
    Pose2d placeCone = new Pose2d(-34.3, -11.3, Math.toRadians(52.5));
    Trajectory preload;
    ...
    public void stacking(double x , double y){
        ...
        preload = drive.trajectoryBuilder(startPose)
                .lineToSplineHeading(new Pose2d(-36, -11.5, Math.toRadians(50)))
        ...
        firstCone = drive.trajectoryBuilder(preload.end())
                .lineToSplineHeading(new Pose2d(-43.7, -13, Math.toRadians(359)),SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(0.3 ,()->{
                    teleop.vertical.downLift();
                })
                .addSpatialMarker(new Vector2d(-43.7 ,-13),() -> {
                   collectFirst();
                })
                .build();
        ...
        traj6 = drive.trajectoryBuilder(traj5.end())
                .lineToSplineHeading(new Pose2d(-43.1, -13, Math.toRadians(359)),SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(0.3,()-> {
                    teleop.vertical.downLift();
                })
                .addSpatialMarker(new Vector2d(-43.1 , -13), () -> {
                   collectThird();
                })
                .build();
        ...
        traj8 = drive.trajectoryBuilder(traj7.end())
                .lineToSplineHeading(new Pose2d(-41.7, -13, Math.toRadians(359)),SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(0.7, () -> {
                    teleop.vertical.downLift();
                })
                .addSpatialMarker(new Vector2d(-41.7 ,-13),() -> {
                   collectFourth();
                })
                .build();
    ...
    public void placeCone(){
        teleop.vertical.outTakeLeft.setPosition(0.02);
        teleop.vertical.outTakeRight.setPosition(1);
